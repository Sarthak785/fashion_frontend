...
class ProductCollection extends Component {
  ...
  addToCart = (productId) => {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0MTNkZGNlNDJmZWY2OTIxOGRlNTAwZiIsImlhdCI6MTY4MDE0MzE2Nn0.eZvG8DoavnGnJ2EjNbFaobpzyt8qP4CYOWXvXn6sMoU"
    console.log(token)
    console.log(productId)
    console.log("http://localhost:5000/cart/insert/" + productId)
    axios.post("http://localhost:5000/cart/insert/" + productId + 5, { productId }, {
      headers: {
  ...
  addToWishlist = (productId) => {
    ...
    console.log(token)
    console.log(productId)
    console.log("http://localhost:5000/wishlist/insert/" + productId)
    axios.post("http://localhost:5000/wishlist/insert/" + productId, { productId }, {
      headers: {
        'authorization': "Bearer " + token,
        'Accept': 'application/json',
        'Content-Type': 'application/json'
            ...
            <div className="row my-lg-5 mb-5">
              ...
              <div className="col-lg-9 mt-lg-0 mt-5 right-product-grid">
                ...
                <div className="card-group">
                  {/* card */}
                  {
                    this.state.productList.slice(0, 3).map((product) => {
                      return (
                        // {/* card */}
